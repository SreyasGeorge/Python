...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/3.0/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&exclude={hourly}&appid={API key}" #Replace with your API key
    ...
    photo1 = ImageTk.PhotoImage(file=f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{firstdayimage}@2x.png")
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{seconddayimage}@2x.png"))
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{thirddayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{fourthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{fifthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{sixthdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    img=(Image.open(f"D:/Python_Programs/WeatherCraze-Weather_Forecast_app/icon/{seventhdayimage}@2x.png"))
    resized_image= img.resize((50,50))
    ...
    day1.config(text=third.strftime("%A"))
    
    fourth=first+timedelta(days=3)
    day1.config(text=fourth.strftime("%A"))
    
    fifth=first+timedelta(days=4)
    day1.config(text=fifth.strftime("%A"))
    
    sixth=first+timedelta(days=5)
    day1.config(text=sixth.strftime("%A"))
    
    seventh=first+timedelta(days=6)
    day1.config(text=seventh.strftime("%A"))

#icon
image_icon = ImageTk.PhotoImage(Image.open("D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/logo.png"))
root.iconphoto(False,image_icon)

Round_box=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Rounded Rectangle 1.png")
...
#search box
Search_image=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Rounded Rectangle 3.png")
myimage=Label(image=Search_image,bg="#57adff")
myimage.place(x=270,y=120)

weat_image=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Layer 7.png")
...
Search_icon=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Layer 6.png")
...
#bottom boxes
firstbox=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Rounded Rectangle 2.png")
secondbox=PhotoImage(file="D:/Python_Programs/WeatherCraze-Weather_Forecast_app/Images/Rounded Rectangle 2 copy.png")
